...
export const SIDEBAR_LINKS: SidebarItem[] = [
  ...
  { title: "Community", titleKey: "community", icon: icons.ACCOUNT_ICON_GROUP, route: RoutesEnum.COMMUNITY, show: false },
  { title: "Company", titleKey: "company", icon: icons.OFFICE_BUILDING_ICON, route: RoutesEnum.COMPANY, show: true },
  { title: "Blog", titleKey: "blog", icon: "mdi-file-document", route: RoutesEnum.BLOG, show: false },
